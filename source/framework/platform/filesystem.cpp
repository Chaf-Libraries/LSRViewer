...
namespace path
{
const std::unordered_map<Type, std::string> relative_paths = {{Type::Assets, ROOT_PATH+std::string("/assets/")},
                                                              {Type::Shaders, ROOT_PATH + std::string("/shaders/")},
                                                              {Type::Storage, ROOT_PATH + std::string("/output/")},
                                                              {Type::Screenshots, ROOT_PATH + std::string("/output/images/")},
                                                              {Type::Logs, ROOT_PATH + std::string("/output/logs/")},
                                                              {Type::Graphs, ROOT_PATH + std::string("/output/graphs/")}};
