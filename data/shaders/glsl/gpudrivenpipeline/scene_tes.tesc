...
void main()
{
    ...
    //outPosPatch1[gl_InvocationID] = inPos[gl_InvocationID];
    // gl_out[gl_InvocationID].gl_Position = gl_in[gl_InvocationID].gl_Position;

    // outPosPatch1[gl_InvocationID] = inPos[gl_InvocationID];
    // outPosPatch2[gl_InvocationID] = inPos[gl_InvocationID];
    // outPosPatch3[gl_InvocationID] = inPos[gl_InvocationID];
